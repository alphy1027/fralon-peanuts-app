...
const UserIcon = ({ className }: { className?: string }) => (
  <svg className={twMerge("h-6 w-6", className)} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      ...
      strokeLinecap="round"
    />
    <path d="M12 12C14.2091 12 16 10.2091 16 8C16 5.79086 14.2091 4 12 4C9.79086 4 8 5.79086 8 8C8 10.2091 9.79086 12 12 12Z" stroke="#0B706A" strokeWidth="2" strokeLinecap="round" />
  </svg>
);
