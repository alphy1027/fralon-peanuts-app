  ...
  return (
    <SectionContainter className="flex flex-col gap-y-12">
      ...
      <section className="flex flex-col gap-y-6">
        ...
        <div className="flex max-w-[400px] flex-col gap-y-4">
          <Input placeholder="Bug description" />
          <Input placeholder="Briefly describe the bug you encountered" />
      ...
      <section className="flex flex-col gap-y-6">
        ...
        <BodyText>
          For any inquiries about our product and services please get in touch with us through our Email fralonpeanuts@gmail.com. You can also get in touch through our help lines +254797000000 or
          +254735000000 or Whatsapp us through the number +254796000000. You can also reach us through our Contact Form by clicking the Contact us button below
        </BodyText>
        <Button size="md">Contact Us</Button>
      </section>
      <section className="flex flex-col gap-y-6">
        <h3 className="text-body-default text-heading-4 font-bold">Help</h3>
        <BodyText>For any technical inquiries about our platform, you can get in touch with our Technical team of Engineers through the Email scripttag@gmail.com </BodyText>
      </section>
    </SectionContainter>
  );
};
