...
const FoundersSection = () => {
  return (
    <SectionContainter className="flex flex-col items-center gap-y-10">
      <SectionTitle>What the owners are saying</SectionTitle>
      <section className="bg-secondary border-primary flex max-w-[400px] items-center rounded-l-[60px] rounded-r-md border sm:rounded-l-xl">
        ...
        <div className="relative flex h-full min-h-fit w-full max-w-[350px] flex-col justify-center p-2 sm:pr-6">
          <div className="">
