...
const ReasonCard = ({ children, index, title }: CardProps) => {
  return (
    <article className="border-secondary flex max-w-[478px] flex-col gap-x-4 rounded-sm border p-4">
      <div className="text-tertiary text-4xl font-black opacity-60">0{index}</div>
      <section className="">
