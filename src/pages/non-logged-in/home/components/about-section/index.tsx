  ...
  return (
    <SectionContainter className="flex flex-wrap items-center justify-center gap-12">
      <div className="flex max-w-[400px] flex-col gap-y-8">
        ...
        <BodyText>
          At [Business Name], we’re more than just a peanut butter company—we’re a family-run business with a passion for crafting high-quality peanut products. From our humble beginnings, we’ve
